...
!   transmatr=transpose(matr); fieldout=matmul(transmatr,field); fieldout=matmul(fieldout,matr)
...
!!$write(6,*)'vec_rot:',(vec_rot(i,1),i=1,3)
!!$write(6,*)'vec_rot:',(vec_rot(i,2),i=1,3)
!!$write(6,*)'vec_rot:',(vec_rot(i,3),i=1,3)
!!$write(6,*)'Tvec_rot:',(trans_vec_rot(i,1),i=1,3)
!!$write(6,*)'Tvec_rot:',(trans_vec_rot(i,2),i=1,3)
!!$write(6,*)'Tvec_rot:',(trans_vec_rot(i,3),i=1,3)
!!$uin=1.
!!$uin(:,5)=0.
!!$uin(:,6)=0.
!write(6,*)'uin before:',uin(1,1),uin(1,2),uin(1,3)
!write(6,*)'uin before:',uin(1,4),uin(1,5),uin(1,6)
...
!   fieldout=matmul(trans_vec_rot,field); field=matmul(fieldout,vec_rot)
...
!write(6,*)'uin:',uin(1,1),uin(1,2),uin(1,3)
!write(6,*)'uin:',uin(1,4),uin(1,5),uin(1,6)
!stop
...
!!$    phi = atan(y/(x+1.e-20))
!!$   else
!!$    phi = pi+atan(y/(x+1.e-20))
!!$   endif
!!$  else
!!$   if (x>0) then
!!$    phi = 2.*pi+atan(y/(x+1.e-20))
!!$   else
!!$    phi = pi+atan(y/(x+1.e-20))
!!$   end if
!!$  end if
