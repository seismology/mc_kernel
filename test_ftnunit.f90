...
subroutine test_all
  ...
  call test(test_rotate_symm_tensor_voigt_src_to_xyz, 'symm tensor rotation src to xyz')
  call test(test_rotate_symm_tensor_voigt_xyz_to_src, 'symm tensor rotation xyz to src')
  call test(test_rotate_symm_tensor_voigt_xyz_src_to_xyz_earth, 'symm tensor rotation xyz src to earth')
  call test(test_rotate_symm_tensor_voigt_xyz_earth_to_xyz_src, 'symm tensor rotation xyz earth to src')
