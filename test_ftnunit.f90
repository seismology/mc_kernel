...
subroutine test_all
  ...
  call test(test_rotate_symm_tensor_voigt_xyz_to_src_1d, 'symm tensor rotation xyz to src')
  call test(test_rotate_symm_tensor_voigt_xyz_src_to_xyz_earth_1d, 'symm tensor rotation xyz src to earth')
  call test(test_rotate_symm_tensor_voigt_xyz_earth_to_xyz_src_1d, 'symm tensor rotation xyz earth to src')
