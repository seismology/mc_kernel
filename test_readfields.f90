...
subroutine test_readfields_load_seismogram()
   ...
   call sem_data%set_params(parameters%fwd_dir, parameters%bwd_dir, 100, parameters%strain_type)
...
subroutine test_readfields_open_files()
   type(semdata_type)   :: sem_data
   character(len=512)   :: fwd_dir, bwd_dir, strain_type
   

   fwd_dir = './wavefield/fwd'
   bwd_dir = './wavefield/bwd'
   strain_type = 'strain_trace'
   
   call sem_data%set_params(fwd_dir, bwd_dir, 100, strain_type) 
